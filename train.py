...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self, vocab_size, n_embed=32, block_size=8):
        ...
        self.sa_head = MultiHeadAttention(n_embed, num_heads=4, head_size=32//4) # This is the self attention head
    ...
    def forward(self, idx, targets=None):
        ...
        x = self.sa_head(x) # (B, T, C) - Apply the self attention head
...
class Head(nn.Module):
    ...
    def __init__(self, n_embed, head_size):
        ...
        self.value = nn.Linear(n_embed, head_size, bias=False) # What should I communicate?
...
if __name__ == "__main__":
    ...
    max_iters = 4500 # how many iterations to train for
